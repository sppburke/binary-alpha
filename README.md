...
BINARY_ALPHA_NVCC=/home/sean/.local/cuda/13.4.1/bin/nvcc cargo build --workspace --locked --features binary-alpha-app/cuda
...
frozen candidate mapping. The accelerator proof uses the same governed wrapper and the immutable
...
host compiler gcc `13.3.0`. The manifest and lockfile pin cudarc `0.19.9`, the newest stable release
