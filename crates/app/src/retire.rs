...
fn plan(
    ...
    for (job, (instrument, catalog_id)) in &selected {
        ...
        // Require completed lossless verification for the selected ancestry's root. A later
        // lineage document cannot grant additional replacement authority just by naming v1.
        let root = continuation_roots[0];
