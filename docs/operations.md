...
`[[instruments.sessions]]`. Registration and acquisition use the same native calendar
validation and execution semantics for both `always` and `weekly` declarations.
